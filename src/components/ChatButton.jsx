...
// Menggunakan BotMessageSquare untuk merepresentasikan Bot CS
import { BotMessageSquare, X, SendHorizontal, Zap, PackageSearch } from 'lucide-react';

export default function ChatButton() {
  const [isOpen, setIsOpen] = useState(false);

  // Data dummy untuk opsi pilihan cepat Bot
  const botOptions = [
  ...
  return (
    <div className="fixed bottom-6 right-6 z-[100] group">
      ...
      {/* ================= POPUP CS BOT (KOLOM TUNGGAL - ANIMATED) ================= */}
      ...
      {/* ================= LABEL PROMPT (ANIMATED - REFINED TEXT) ================= */}
      ...
      {/* ================= TOMBOL FLOATING BULAT SEMPURNA (ESTETIK & SMOOTH) ================= */}
      <button 
      ...
      >
        {/* Ikon dengan animasi rotasi saat terbuka */}
